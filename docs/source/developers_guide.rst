...
Cloudml-UI backend installation for MacOS
------------------------------------------
...
After the above step, a temporary key and secret will be automatically generated for you.
Wait for Maksym Novozhylov or someone from his team to give you the actual key and secret. 
They will contact you once you execute the above step.
...
Create ja_quick_info table in psql::
    ...
    Then run this copy command in psql console
    cloudml=# COPY ja_quick_info FROM '/doc/dump' CSV HEADER;
