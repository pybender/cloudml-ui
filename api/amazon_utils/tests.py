...
class AmazonDynamoDBHelperTests(TestCase):
    ...
    def test_batch_write_get_items_delete_items(self):
        self.helper.batch_write(AmazonDynamoDBHelperTests.TEST_TABLE_NAME,
                             [{'object_id': 1, 'id': 'one', 'data': 'd1'},
                              {'object_id': 2, 'id': 'two', 'data': 'd2'},
                              {'object_id': 3, 'id': 'three', 'data': 'd3'}])
        ...
        self.assertEqual(items, [{'object_id': 3, 'id': 'three', 'data': 'd3'}])

        self.helper.delete_items(AmazonDynamoDBHelperTests.TEST_TABLE_NAME,
