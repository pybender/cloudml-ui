...
describe "weights", ->
  ...
  describe "WeightsCtrl", ->
    ...
    it "should load weights list", inject () ->
      ...
      encodeURIComponent('name,value,css_class') + '&sort_by=name'
    ...
    it "should load weights brief list", inject () ->
      url = settings.apiUrl + 'weights/somemodelid/action/brief/?npage=1&ppage=1&show=' +
      encodeURIComponent('name,value,css_class')
