...
def upgrade():
    ...
    op.add_column('model', sa.Column('on_s3', sa.Boolean(), default=False))
    op.add_column('feature_set', sa.Column('locked', sa.Boolean(), default=False))
    op.add_column('xml_import_handler', sa.Column('on_s3', sa.Boolean(), default=False))
    ### end Alembic commands ###


def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('xml_import_handler', 'on_s3')
    op.drop_column('feature_set', 'locked')
    op.drop_column('model', 'on_s3')
